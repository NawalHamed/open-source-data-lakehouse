...
df = spark.read.option("multiline", "true").json("s3a://semi-structured-raw-data/batch/*.json")
...
df.writeTo("nessie.silver_layer.airline_info").createOrReplace()

# Step 6: Verify
spark.read.table("nessie.silver_layer.airline_info").show(5)
